...
class SpriteManager(object):
   ...
   class _SM(object):
      ...
      def _loadImage(self, fileName, sheet=False):
         ...
         fullImage = pygame.transform.scale_by(fullImage, SpriteManager._SM._SCALE.get(fileName, 1))

         fullImage = pygame.transform.flip(fullImage, SpriteManager._SM._FLIP.get(fileName, False), False)
